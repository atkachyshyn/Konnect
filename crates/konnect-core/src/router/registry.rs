...
pub static ALL_TOOLSETS: &[ToolsetMeta] = &[
    ...
    ToolsetMeta {
        name: "sch_layout",
        description: "Deterministic bounded Top-K local schematic layout planning",
        category: "schematic",
        tool_count: 1,
    },
    ToolsetMeta {
    ...
    ToolsetMeta {
        name: "sch_hierarchy",
        description: "Hierarchical sheets: add/edit/move/delete/duplicate a sheet, move existing objects between sheets for hierarchy migration/restructure, safe cleanup of unlinked empty child schematics, hierarchy and page-numbering queries, import/add/edit/delete sheet pins, pin/label sync validation",
        category: "schematic",
        tool_count: 14,
    },
    ToolsetMeta {
...
pub fn tools_for(name: &str) -> Option<Vec<ToolDef>> {
    ...
    match name {
        ...
        "sch_layout" => Some(sch_layout::tools()),
